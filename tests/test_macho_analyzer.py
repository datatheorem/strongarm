...
class TestMachoAnalyzer:
    ...
    def test_parses_cfstrings_with_rebases__ios15(self):
        ...
        chained_fixup_pointers_binary = test_binary_with_name("iOS15_chained_fixup_pointers")
...
class TestMachoAnalyzerDynStaticChecks:
    ...
    def test_xref_objc_opt_new(self) -> None:
        ...
        binary = test_binary_with_name("iOS13_objc_opt")
    ...
    def test_find_string_xref__adr_pattern(self) -> None:
        ...
        binary = test_binary_with_name("TestBinary5")
        analyzer = MachoAnalyzer.get_analyzer(binary)
